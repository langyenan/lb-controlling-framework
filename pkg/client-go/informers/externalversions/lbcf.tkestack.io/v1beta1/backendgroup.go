	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LbcfV1beta1().BackendGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LbcfV1beta1().BackendGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&lbcftkestackiov1beta1.BackendGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backendGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lbcftkestackiov1beta1.BackendGroup{}, f.defaultInformer)
}
